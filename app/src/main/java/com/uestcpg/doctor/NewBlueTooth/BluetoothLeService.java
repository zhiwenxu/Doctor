...
package com.uestcpg.doctor.NewBlueTooth;
...
//
//            public RecvThread(BluetoothGatt gatt, final int status){
...
//        }
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt,
            ...
            if (bytesreceive.length != 0) {
                ...
                Toast.makeText(context, str_receive, Toast.LENGTH_SHORT).show();
            }
        }
    };
